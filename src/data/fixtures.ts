...
const snapshots: TimeSnapshot[] = [
  {
    ...
    trains: [
      train("train-1-101", "1호선", "종각역 진입", "청량리 방면", false, 76, "종로3가", 2),
      train("train-2-201", "2호선", "삼성역 진입", "신도림 방면", false, 84, "선릉", 2),
      train("train-2-202", "2호선", "홍대입구 출발", "잠실 방면", false, 71, "신촌", 3),
      train("train-3-301", "3호선", "압구정역 출발", "수서 방면", false, 68, "신사", 2),
      train("train-4-401", "4호선", "혜화역 정차", "사당 방면", false, 81, "동대문", 2),
      train("train-5-501", "5호선", "여의도역 접근", "상일동 방면", false, 73, "공덕", 3),
      train("train-6-601", "6호선", "이태원역 통과", "봉화산 방면", false, 60, "약수", 4),
      train("train-7-701", "7호선", "청담역 대기", "장암 방면", true, 88, "강남구청", 6),
      train("train-7-702", "7호선", "건대입구 접근", "석남 방면", false, 62, "어린이대공원", 4),
      train("train-8-801", "8호선", "잠실역 출발", "모란 방면", false, 65, "석촌", 2),
      train("train-9-901", "9호선", "당산역 진입", "종합운동장 방면", false, 79, "여의도", 1),
    ],
    summary: summary(
  ...
  },
  {
    ...
    trains: [
      train("train-1-101", "1호선", "서울역 정차", "청량리 방면", false, 58, "시청", 3),
      train("train-2-201", "2호선", "역삼역 접근", "신도림 방면", false, 72, "강남", 3),
      train("train-2-202", "2호선", "합정역 출발", "잠실 방면", false, 64, "홍대입구", 2),
      train("train-3-301", "3호선", "안국역 정차", "수서 방면", false, 55, "종로3가", 2),
      train("train-4-401", "4호선", "한성대입구 통과", "사당 방면", false, 62, "혜화", 3),
      train("train-5-501", "5호선", "광화문역 접근", "상일동 방면", false, 60, "동대문역사문화공원", 4),
      train("train-6-601", "6호선", "공덕역 정차", "봉화산 방면", false, 52, "삼각지", 2),
      train("train-7-701", "7호선", "학동역 통과", "장암 방면", false, 69, "강남구청", 4),
      train("train-7-702", "7호선", "군자역 대기", "석남 방면", false, 58, "어린이대공원", 5),
      train("train-8-801", "8호선", "강동구청 출발", "모란 방면", false, 50, "몽촌토성", 3),
      train("train-9-901", "9호선", "노량진 정차", "종합운동장 방면", false, 64, "흑석", 3),
    ],
    summary: summary(
  ...
  },
  {
    ...
    trains: [
      train("train-1-101", "1호선", "종로3가 통과", "청량리 방면", false, 80, "종로5가", 2),
      train("train-2-201", "2호선", "교대역 정차", "신도림 방면", false, 79, "서초", 2),
      train("train-2-202", "2호선", "이대역 접근", "잠실 방면", false, 66, "아현", 3),
      train("train-3-301", "3호선", "고속터미널 출발", "수서 방면", true, 86, "양재", 6),
      train("train-4-401", "4호선", "동대문역 정차", "사당 방면", false, 84, "명동", 2),
      train("train-5-501", "5호선", "공덕역 통과", "상일동 방면", false, 78, "충정로", 3),
      train("train-6-601", "6호선", "약수역 접근", "봉화산 방면", false, 70, "동묘앞", 3),
      train("train-7-701", "7호선", "강남구청역 대기", "장암 방면", true, 91, "학동", 7),
      train("train-7-702", "7호선", "뚝섬유원지역 통과", "석남 방면", false, 60, "청담", 5),
      train("train-8-801", "8호선", "석촌역 진입", "모란 방면", false, 73, "송파", 2),
      train("train-9-901", "9호선", "여의도 정차", "종합운동장 방면", false, 82, "노량진", 1),
    ],
    summary: summary(
  ...
  },
  {
    ...
    trains: [
      train("train-1-101", "1호선", "시청역 진입", "청량리 방면", false, 88, "종각", 1),
      train("train-2-201", "2호선", "삼성역 정차", "신도림 방면", false, 89, "선릉", 2),
      train("train-2-202", "2호선", "홍대입구 정차", "잠실 방면", false, 78, "신촌", 3),
      train("train-3-301", "3호선", "신사역 출발", "수서 방면", false, 82, "압구정", 2),
      train("train-4-401", "4호선", "명동역 진입", "사당 방면", false, 90, "서울역", 1),
      train("train-5-501", "5호선", "여의도 정차", "상일동 방면", false, 86, "여의나루", 3),
      train("train-6-601", "6호선", "삼각지역 정차", "봉화산 방면", false, 75, "이태원", 2),
      train("train-7-701", "7호선", "청담역 대기", "장암 방면", true, 92, "강남구청", 8),
      train("train-7-702", "7호선", "건대입구 접근", "석남 방면", false, 67, "어린이대공원", 4),
      train("train-8-801", "8호선", "잠실역 정차", "모란 방면", false, 81, "석촌", 2),
      train("train-9-901", "9호선", "고속터미널 정차", "종합운동장 방면", true, 93, "신논현", 4),
    ],
    summary: summary(
  ...
  },
  {
    ...
    trains: [
      train("train-1-101", "1호선", "동대문역 출발", "청량리 방면", false, 44, "신설동", 3),
      train("train-2-201", "2호선", "잠실역 접근", "신도림 방면", false, 54, "종합운동장", 4),
      train("train-2-202", "2호선", "시청역 출발", "잠실 방면", false, 48, "을지로입구", 2),
      train("train-3-301", "3호선", "양재역 접근", "수서 방면", false, 40, "수서", 5),
      train("train-4-401", "4호선", "사당역 정차", "사당 방면", false, 47, "동작", 2),
      train("train-5-501", "5호선", "광나루역 통과", "상일동 방면", false, 42, "천호", 3),
      train("train-6-601", "6호선", "안암역 정차", "봉화산 방면", false, 38, "고려대", 2),
      train("train-7-701", "7호선", "논현역 통과", "장암 방면", false, 52, "반포", 5),
      train("train-7-702", "7호선", "상봉역 접근", "석남 방면", false, 46, "면목", 3),
      train("train-8-801", "8호선", "가락시장 출발", "모란 방면", false, 41, "문정", 3),
      train("train-9-901", "9호선", "신논현 출발", "종합운동장 방면", false, 50, "선정릉", 2),
    ],
    summary: summary(
  ...
  },
  {
    ...
    trains: [
      train("train-1-101", "1호선", "청량리 출발", "서울역 방면", false, 87, "제기동", 2),
      train("train-2-201", "2호선", "역삼역 정차", "신도림 방면", true, 93, "강남", 7),
      train("train-2-202", "2호선", "합정역 접근", "잠실 방면", false, 82, "홍대입구", 3),
      train("train-3-301", "3호선", "압구정 정차", "대화 방면", false, 84, "신사", 2),
      train("train-4-401", "4호선", "서울역 정차", "사당 방면", false, 91, "명동", 1),
      train("train-5-501", "5호선", "왕십리 진입", "상일동 방면", false, 89, "답십리", 2),
      train("train-6-601", "6호선", "합정역 정차", "봉화산 방면", false, 76, "디지털미디어시티", 3),
      train("train-7-701", "7호선", "고속터미널역 정차", "장암 방면", false, 78, "반포", 4),
      train("train-7-702", "7호선", "뚝섬유원지역 출발", "석남 방면", false, 70, "청담", 5),
      train("train-8-801", "8호선", "잠실역 접근", "암사 방면", false, 79, "몽촌토성", 2),
      train("train-9-901", "9호선", "당산역 정차", "개화 방면", true, 90, "염창", 5),
    ],
    summary: summary(
